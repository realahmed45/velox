    ...
    <div className="bg-white min-h-screen font-inter selection:bg-[#FF6B00]/30 text-black">
      ...
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 ${scrollY > 50 ? 'backdrop-blur-xl bg-white/80 py-4 border-b border-black/5' : 'bg-transparent py-8'}`}>
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex justify-between items-center text-black">
          <Link to="/" className="text-3xl font-black tracking-tighter uppercase italic italic">VELOX<span className="text-[#FF6B00]">.</span></Link>
      ...
      <footer className="py-20 px-6 bg-black border-t border-white/5 text-center">
         <div className="text-2xl font-black text-white italic italic uppercase mb-6">VELOX<span className="text-[#FF6B00]">.</span></div>
         <p className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-600">© 2026 VELOX UNIFIED SOLUTIONS UNIT. ENGINEERING THE FUTURE. | velox.operations09@gmail.com</p>
      </footer>
    </div>
  );
}
