...
export default function AnalyticsView() {
  return (
    <div>
      <h2 className="text-4xl font-black text-gray-900 tracking-tight mb-10">Analytics Overview</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg">
          <h3 className="text-lg font-bold mb-6">Task Completion Rate</h3>
          <div className="flex items-end gap-2 h-64">
            {[40, 65, 45, 80, 55, 90, 75].map((h, i) => (
              <div key={i} className="flex-1 bg-gray-100 rounded-t-xl relative group overflow-hidden">
                <div 
